...
export const BUILDINGS: readonly Building[] = [
  ...
  { key: "face-mapping", sign: "FACE MAP", status: "FORTHCOMING", center: [6.5, 0, 3.5], size: [4, 3.4, 4], windows: false, shade: "blank", route: null, at: 1 },
];
...
export const KEYFRAMES: readonly Keyframe[] = [
  ...
  { at: 1, pose: framing(buildingByKey("face-mapping"), 1.15, 12.5) },
];
