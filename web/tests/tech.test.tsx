...
describe("technician room", () => {
  ...
  it("sections come in the product's order: works, programmes, paste, hashes, refuse codes; the substrate is a closed details", () => {
    renderAt("/tech");
    ...
    expect(idx(/works/)).toBeLessThan(idx(/programmes and fixtures/));
    ...
    expect(idx(/hashes/)).toBeLessThan(idx(/refuse codes/));
